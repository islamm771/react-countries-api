    ...
    return (
        <div className="border shadow-md rounded-lg">
            ...
            <div className="px-4 pt-6 pb-8">
                ...
                <p><b className="font-semibold">Population:</b> {country.population}</p>
                <p><b className="font-semibold">Region:</b> {country.region}</p>
                <p><b className="font-semibold">Capital:</b> {country.capital}</p>
            </div>
        </div>
    )
}
